...
public class DataTypeUtil {
    ...
    public static int bytesCopy(byte[] source, byte[] dest, int len) {
        try {
            ...
            LogUtil.getLogger().error("ByteProcess_Java" + ":bytesCopy:", ex);
    ...
    public static byte[] hexs2Bytes(java.lang.String src) {
        try {
            ...
            LogUtil.getLogger().error("ByteProcess_Java" + ":hexs2Bytes:", e);
            return null;
        }
    }
    ...
    public static byte hexs2Byte(java.lang.String src) {
        return (byte) Integer.decode("0x" + src).intValue();
    }
    ...
    public static void main(String[] args) {
        ...
        if (true) {
            ...
            // Object a="100.1";
            // args2[0]=a;
            Object obj = invokeMethod("zxt.pub.util.DataTypeUtil", "toInt",
                    new Object[] { "100.09" });
            System.exit(0);
        }
        ...
        // ht.put("04", "外资季报");
        // ht.put("02", "增值税小规模");
        // LogUtil.getLogger().debug(ht);
        // LogUtil.getLogger().debug(sortHashTable(ht));
    ...
    public static String getHex4StrFixedLen(String str, int fixedLen) {
        str = toNotNullString(str);
        String strHex = bytes2Hexs(str.getBytes());
        while (strHex.length()/2<fixedLen) {
            strHex += "00";
        }
        return strHex;
    }

    public static String getHex4StrFixedLen(String str, String fillStr, int fixedLen) {
        str = toNotNullString(str);
        String strHex = bytes2Hexs(str.getBytes());
        while (strHex.length()/2<fixedLen) {
            strHex += fillStr;
    ...
    public static String charFill(String str, int fixedLen, String fillstr) {
        str = toNotNullString(str);
        while (str.length()<fixedLen*2) {
            str += fillstr;
        }
        return str;
    }

    public static String charFillpre(String str, int fixedLen, String fillstr) {
        str = toNotNullString(str);
        while (str.length()<fixedLen*2) {
            str = fillstr + str;
        }
    ...
    public static String charFillpreSingle(String str, int fixedLen, String fillstr) {
        str = toNotNullString(str);
        while (str.length()<fixedLen) {
            str = fillstr + str;
        }
        return str;
    }
     ...
     * @return
     */
    public static byte[] taskMark4pic(String filepath) {
        byte[] b = null;
        try {
            BufferedImage image = new BufferedImage(32, 16,	BufferedImage.TYPE_INT_RGB);
